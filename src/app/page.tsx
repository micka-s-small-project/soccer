      ...
      >
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight text-black dark:text-zinc-50">
            Drag and drop an image to generate the World Cup AI Soccer Camera
            Generator.
          </h1>
          <select
            value={selectedCountry}
            onChange={(e) => setSelectedCountry(e.target.value)}
            className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg p-3 text-sm font-medium text-black dark:text-zinc-50 w-full max-w-lg focus:outline-none focus:ring-2 focus:ring-lime-400"
          >
